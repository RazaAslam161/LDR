...
- **Privacy:** in-app account deletion is real and cascades; no ads, no analytics SDK, no AD_ID; crash reports strip exception messages on-device; retention cron jobs all active.
