...
class MemoryThreadRepository {
  ...
  static Future<String> propose({
    ...
    await _c.from('memory_threads').insert({
      ...
      'couple_id': coupleId,
      'proposer': proposer,
      'title_cipher': titleBlob,
      'title_nonce': titleNonceBytes,
      'happened_on': happenedStr,
      if (noteBlob != null) 'note_cipher': noteBlob,
      if (noteNonceBytes != null) 'note_nonce': noteNonceBytes,
      if (photoBlob != null) 'photo_cipher': photoBlob,
      if (photoNonceBytes != null) 'photo_nonce': photoNonceBytes,
