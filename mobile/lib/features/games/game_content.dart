...
const _truthCoresUr = <TDTier, List<String>>{
  ...
  TDTier.flirty: [
    ...
    'meri kaunsi tasveer dekh kar tum scroll karte karte ruk gaye',
    'agar main abhi saamne hoti to pehla lafz kya hota',
    ...
    'main tumhare kaan mein koi raaz kahoon to reaction kya hoga',
    'door reh kar bhi main tumhe kaise pareshaan kar deti hoon',
    'mujhe dobara gale lagane ka khayal aaye to shuruaat kaise hogi',
  ...
  TDTier.spicy: [
    'hamare baare mein aisi ek baat jo tumne kabhi zubaan par nahi laayi',
    'tumhe pehli baar kab laga ke yeh sab serious hai',
    'itni doori se mujhe chahna sabse mushkil kab lagta hai',
    'koi cheez jo tumhe mujhse chahiye thi aur tumne kabhi maangi nahi',
    'hamare future ke baare mein sabse zyada kis baat ki fikar hoti hai',
    'hamari kaunsi larai abhi tak tumhare dil mein reh gayi hai',
    'tumhe kya lagta hai mujhe tumhare baare mein abhi tak kya nahi pata',
    'kab tum mujhe sabse qareeb mehsoos hue bina ek jagah hue',
    'hamari shuruaat mein agar kuch badal sakte to kya badalte',
    'mera koi purana version hai jo tumhe aaj bhi yaad aata hai',
    'kis baat par tum mujhe bina bataye maaf kar dete ho',
    'iss doori mein tumhe sabse zyada kis baat ka darr lagta hai',
    'aakhri baar hamare baare mein soch kar kab aankh bhar aayi thi',
    'mera kaunsa waada tum abhi tak thaame hue ho',
    'apne din ka kaunsa hissa chahte ho ke main dekh sakoon',
    'koi baat jis ka bura lagta hai magar tum zahir nahi karte',
    'paanch saal baad hamari zindagi tumhe kaisi dikhti hai',
    'mujhe jagah dene ke liye tumhe kya peeche chhodna pada',
    'kab tumhe mujhe le kar sabse zyada be-yaqeeni hoti hai',
    'agar koi hamare baare mein poochhe to tum kya kehna chahoge',
  ],
};
...
const _truthCoresEn = <TDTier, List<String>>{
  ...
  TDTier.flirty: [
    'what about me does your attention keep drifting back to',
    'which picture of mine stopped you mid-scroll',
    'if I walked in right now, what would you say first',
    ...
    'if I whispered a secret in your ear, how would you react',
    'how do I still manage to fluster you from this far away',
    'when you imagine holding me again, how does it start',
  ...
  TDTier.spicy: [
    'what is one thing about us you have never said out loud',
    'when did you first know this was serious for you',
    'when is loving me from this far the hardest',
    'is there something you needed from me and never asked for',
    'what worries you most when you think about our future',
    'which argument of ours is still sitting with you',
    'what do you think I still do not know about you',
    'when have you felt closest to me without us being in one place',
    'if you could change one thing about how we started, what',
    'is there an older version of me you miss',
    'what do you forgive me for without ever mentioning it',
    'what frightens you most about the distance',
    'when did you last get teary thinking about us, and why',
    'which promise of mine are you still holding on to',
    'what part of your day do you wish I could see',
    'is there something you pretend not to mind',
    'what does our life look like five years from now',
    'what did you leave behind to make room for me',
    'when do you feel least sure of me',
    'if someone asked about us, what would you want to say',
  ],
};
...
const _dareCoresUr = <TDTier, List<String>>{
  ...
  TDTier.flirty: [
    ...
    'ek teasing voice note bhejo ke milne par sabse pehle kahaan jayenge',
    ...
    'hanste hue ek shararati photo bhejo',
    'meri sabse attractive cheez bol kar, mujhe dekhte hue record karo',
    "ek 'kaash tum yahan hote' wali photo banao aur bhejo",
    'woh ek dance move video mein dikhao jo tumhe sach mein aata hai',
    "ek line bolo bilkul 'tum mere ho' wale andaaz mein",
    'apni aankhon se ek shararati ishaara karke video bhejo',
  ],
  TDTier.spicy: [
    'jo baat tum roke hue ho abhi ek message mein keh do',
    'ek voice note bhejo jisme woh darr batao jo kabhi nahi bataya',
    'agle saal ke liye ek waada likh kar bhejo jo tum nibhana chahte ho',
    'ek lamha batao jab tumhe mujh par fakhar hua aur tumne kaha nahi',
    'kisi cheez ki tasveer bhejo jo tumhe roz meri yaad dilati hai',
    'batao doori khatam hone ke baad hamara pehla din kaisa hoga',
    'ek cheez batao jo tum theek karna chahte ho, narmi se kehna',
    'aakhri baar kab tumne kisi ke saamne meri taraf daari ki',
    'jahaan abhi ho wahan ki tasveer bhejo, jaisi hai waisi hi',
    'bol kar batao hamare rishte ki kaunsi baat pasand hai, meri nahi',
    'ek khat ki pehli line likho jo tum bhejte agar main saal bhar door hoti',
  ],
};
...
const _dareCoresEn = <TDTier, List<String>>{
  ...
  TDTier.flirty: [
    ...
    'send a teasing voice note about where we go first when we meet',
    ...
    'send a mischievous photo caught mid-laugh',
    'record yourself looking at me and naming the most attractive thing about me',
    "take and send an 'I wish you were here' photo",
    'show me on video the one dance move you swear you can do',
    "say one line exactly like you mean 'you are mine'",
    'send a video giving me your cheekiest look with just your eyes',
  ],
  TDTier.spicy: [
    'say the thing you have been holding back, right now, in one message',
    'record a voice note telling me a fear you have never told me',
    'write down one promise you want to keep this year and send it',
    'tell me about a time you were proud of me and never said so',
    'send a photo of something that reminds you of me every day',
    'describe our first day together after the distance ends',
    'name one thing you want us to fix, and say it kindly',
    'tell me the last time you defended me to someone',
    'send a picture of where you are, exactly as it is right now',
    'say out loud what you love about us, not about me',
    'write the first line of a letter you would send if I were away a year',
  ],
};
