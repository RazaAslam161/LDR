      ...
      const FaqSection('Your account and your data', [
        ...
        FaqEntry(
          ...
          'Either of you can end it: Settings → Partner → “Remove partner”. '
              ...
              'permanently deleted. Connecting again is the same as the first '
              'time: one of you shares a code and the other enters it. It is '
              'not automatic, and it does not happen to anyone who has not '
