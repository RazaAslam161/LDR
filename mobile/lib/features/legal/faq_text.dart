      ...
      const FaqSection('Your account and your data', [
        ...
        FaqEntry(
          ...
          'Either of you can end it: Settings → Partner → “Remove partner”. '
              ...
              'messages, photos, videos, Closer content — is kept for 30 days '
              'and then permanently deleted. For those 30 days the shared '
              'gallery stays open to both of you, read-only: you can still '
              'look through it and save anything from it into your own private '
              'vault, which is yours to keep, but nothing more can be added to '
              'it or removed from it. Anything you have not saved goes when '
              'the 30 days are up.\n\nTwo things end it sooner. Linking with '
              'someone new ends YOUR access at once and for good, including if '
              'that new link later ends. And either of you can end it outright '
              'at any time, which erases everything immediately for both of '
              'you.\n\nWithin those 30 days the couple itself can still be '
              'brought back, which restores everything — but it takes both of '
              'you: one asks to reconnect and the other agrees. Neither of you '
              'can restore it alone, and once someone has declined a request '
              'that same person cannot ask again. Pairing again with a fresh '
              'code is not the same thing — that starts a new couple, and the '
              'old history is still erased on schedule.\n\nYour private vault '
              'is not part of that. It '
