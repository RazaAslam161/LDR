      ...
      const FaqSection('Your account and your data', [
        ...
        FaqEntry(
          ...
          'Either of you can end it: Settings → Partner → “Remove partner”. '
              ...
              'the app.\n\nFrom the moment it ends, the shared gallery stays '
              'with both of you, read-only: you can still open it and save '
              'anything from it into your own vault, but nothing more can be '
              'added to it or removed from it. The rest of the shared history '
              '— messages, Closer content — is kept but can no longer be '
              'opened by either of you.\n\nAll of it is erased once you have '
              'both linked with someone else. Linking with someone new ends '
              'YOUR access to the old gallery immediately and permanently, '
              'including if that new link later ends. Either of you can also '
              'end it outright at any time, which erases everything at once '
              'for both of you.\n\nSeparately, for the first 30 days the '
              'couple itself can be brought back, which restores everything — '
              'but it takes both of you: one asks to reconnect and the other '
              'agrees. Neither of you can restore it alone, and once someone '
              'has declined a request that same person cannot ask again. '
              'Pairing again with a fresh code is not the same thing — that '
              'starts a new couple.\n\nYour private vault is not part of that. '
              'It '
